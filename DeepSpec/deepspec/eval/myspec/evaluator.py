...
from deepspec.eval.myspec.confidence_head import ConfidenceHeadRecorder
...
class Qwen3MySpecEvaluator(BaseEvaluator):
    EVAL_ATTN_IMPLEMENTATION = "sdpa"
    draft_model_cls = Qwen3MySpecModel
    ...
    def build_models(self) -> tuple[object, Qwen3MySpecModel, AutoTokenizer]:
    ...
    def _post_verify(
        ...
        if self.confidence_head_recorder is None:
            return
        assert isinstance(proposal, MySpecDraftProposal)
